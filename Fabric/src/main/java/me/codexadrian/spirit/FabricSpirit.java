...
public class FabricSpirit implements ModInitializer {
    ...
    public static final Item SOUL_CAGE_ITEM = new BlockItem(SOUL_CAGE, new Item.Properties().tab(FabricSpirit.SPIRIT).rarity(Rarity.EPIC));
    public static final Item SOUL_CRYSTAL = new DivineCrystalItem(new Item.Properties().tab(FabricSpirit.SPIRIT).stacksTo(1).rarity(Rarity.RARE));
    ...
    public static final Item BROKEN_SPAWNER_ITEM = new BlockItem(BROKEN_SPAWNER, new Item.Properties().tab(FabricSpirit.SPIRIT).rarity(Rarity.EPIC));
    @Override
