...
import earth.terrarium.spirit.common.mixin.CompositeStateAccessor;
import earth.terrarium.spirit.common.mixin.RenderStateShardAccessor;
import earth.terrarium.spirit.common.mixin.TextureStateShardAccessor;
...
// Credit to:https://github.com/TelepathicGrunt/Bumblezone/blob/1.20.x-Arch/common/src/main/java/com/telepathicgrunt/the_bumblezone/client/rendering/transparentitem/TranslucentItemRenderTypeBuffer.java#L48 who took it from:https://github.com/SlimeKnights/TinkersConstruct/blob/1.18.2/src/main/java/slimeknights/tconstruct/smeltery/client/util/CastingItemRenderTypeBuffer.java
    ...
    public @NotNull VertexConsumer getBuffer(@NotNull RenderType type) {
        if (MAKE_TRANSPARENT.contains(((RenderStateShardAccessor)type).getName())) {
            ...
            if (composite != null) {
                ...
                if (((CompositeStateAccessor) (Object) state).getTextureState() instanceof RenderStateShard.TextureStateShard textureState) {
