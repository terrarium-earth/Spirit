package earth.terrarium.spirit.api.souls.util;
...
public class SoulIngredient implements Predicate<SoulStack> {
    public static final Codec<SoulIngredient> CODEC = FluidIngredient.listAndObjectCodec(HolderSetCodec.of(BuiltInRegistries.ENTITY_TYPE), SoulIngredient::getSets, SoulIngredient::new);
    ...
    public List<HolderSet<EntityType<?>>> getSets() {
        return sets;
    }
