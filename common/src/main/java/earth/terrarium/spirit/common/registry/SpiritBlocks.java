...
public class SpiritBlocks {
    ...
    public static final RegistryEntry<Block> RAGING_SOUL_FIRE = BLOCKS.register("raging_soul_fire", () -> new RagingSoulFireBlock(BaseElements.EMBER, BlockBehaviour.Properties.of(Material.FIRE, MaterialColor.FIRE).noCollission().instabreak().lightLevel(arg -> 10).sound(SoundType.WOOL)));
