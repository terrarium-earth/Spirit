...
public class SpiritPlugin implements REIClientPlugin {
    ...
    public void registerDisplays(DisplayRegistry registry) {
        registry.registerRecipeFiller(PedestalRecipe.class, SpiritMisc.SOUL_TRANSMUTATION_RECIPE.get(), PedestalDisplay::new);
        registry.registerRecipeFiller(Tier.class, SpiritMisc.TIER_RECIPE.get(), TierDisplay::new);
        registry.registerRecipeFiller(SoulEngulfingRecipe.class, SpiritMisc.SOUL_ENGULFING_RECIPE.get(), SoulEngulfingDisplay::new);
    }
}
