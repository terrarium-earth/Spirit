...
public class SpiritFluids {
    ...
    public static final RegistryObject<FlowingFluid> MOLTEN_SOUL_STEEL = ForgeRegistryHelper.FLUIDS.register("molten_soul_steel", () -> new ForgeFlowingFluid.Source(getProperties()));

    public static final RegistryObject<FlowingFluid> FLOWING_MOLTEN_SOUL_STEEL = ForgeRegistryHelper.FLUIDS.register("flowing_molten_soul_steel", () -> new ForgeFlowingFluid.Flowing(getProperties()));

    public static final RegistryObject<Block> MOLTEN_SOUL_STEEL_BLOCK = ForgeRegistryHelper.BLOCKS.register("molten_soul_steel_block", () -> new LiquidBlock(MOLTEN_SOUL_STEEL, Block.Properties.of(Material.LAVA).lightLevel(value -> 15).randomTicks().strength(100.0F).noDrops()));
